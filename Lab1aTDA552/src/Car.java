...
abstract public class Car implements Movable{
     ...
     * @param i amount of doors
     */
    protected void setNrDoors(int i){
        nrDoors = i;
    }
     ...
     * @param s model name
     */
    protected void setModelName(String s){
        modelName = s;
    }

    /**
     * Sets the engine power
     * @param i value of engine power
     */
    protected void setEnginePower(double i){
        enginePower = i;
    }
